  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MainProvayder>(builder: (context, date, child) {
      return FutureBuilder(
        future: mainProvider.getFavList(Constants.GARNISHES_KEY),
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ProductItem(
                          Meal.saladsUZ[snapshot.data[index]],
                          snapshot.data[index],ProductType.GARNISHES,Constants.GARNISHES_KEY
                          ,isFavourite: true,
                        );
                      },
                    ),
